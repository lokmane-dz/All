package me.lokmvne.learning.presentation.navGraph
...
import me.lokmvne.learning.GoogleAuthUiClient
import me.lokmvne.learning.SignInViewModel
import me.lokmvne.learning.presentation.authScreens.AuthScreens
import me.lokmvne.learning.presentation.authScreens.HomeScreen
import me.lokmvne.learning.presentation.authScreens.SignInScreen
...
fun AuthNavGraph(
    ...
    NavHost(navController = navHostController, startDestination = AuthScreens.SigInScreen.route) {
        composable(AuthScreens.SigInScreen.route) {
            ...
            SignInScreen(navController = navHostController, googleSignIn = {
                lifecycleCoroutineScope.launch {
